...
from exam_guru_api.storage_reconciliation.jobs import (
...
def test_clean_database_migration_enables_pgvector(database_url: str) -> None:
    ...
    assert migration_revision == "0050_programme_knowledge_context"
...
def test_extraction_outbox_migration_backfills_honestly_and_downgrades_cleanly(
    ...
    assert revision == "0050_programme_knowledge_context"
